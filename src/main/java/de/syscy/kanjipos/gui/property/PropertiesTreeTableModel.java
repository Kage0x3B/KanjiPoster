...
public class PropertiesTreeTableModel extends DefaultTreeTableModel {
	 ...
	 *
	 * @param data The data to show in the editor (must be a Map or List).
	 * @throws IllegalArgumentException In case the data is not an instance of Map or List.
	 */
	 ...
	 *
	 * @param data The data; either a <tt>Map&lt;String, Object&gt;</tt>, or a
	 *             <tt>List&lt;Object&gt;</tt>
	 * @throws IllegalArgumentException In case the data is not an instance of Map or List.
	 */
